...
export const EXAMPLES = {
  ...
  jsx: {
    ...
    code: `<div> <h1>환영합니다 {userName}님</h1> <p>React를 배워보세요!</p> </div>`,
  },
  props: {
    title: "Props",
    description:
      "Component는 props라고 불리는 임의의 입력값을 받아들입니다. 함수의 매개변수와 같은 역할을 합니다.",
    code: ` function Welcome(props) { return <h1>안녕하세요, {props.name}님!</h1>; }`,
  },
  state: {
    title: "State",
    description:
      "State는 React Component가 사용자 액션, 네트워크 응답, 기타 요인에 따라 시간이 지남에 따라 출력을 변경할 수 있게 해줍니다.",
    code: ` function Counter() { const [isVisible, setIsVisible] = useState(false); function handleClick() {
    setIsVisible(true);}
