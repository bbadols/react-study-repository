...
function LoginSystem() {
  ...
  // username : 상태 저장(회원명) 변수ㅡ setUsername : 상태 변경을
  ...
  const handleLogout = () =>{
    ...
    setIsLoggedIn(false); // sate hook 함수 이용해 정보 변경
  }
  ...
  return (
    <div className="login-system">
      <h2>로그인 시스템</h2>
      {/* 삼항 연산자 : isLoggedIn state 값에 따라 true이면 로그인 화면 렌더링과 false이면 비로그인 화면 렌더링을 구분 */}
      {/* 로그인된 상태의 화면 */}
      {isLoggedIn ? (
