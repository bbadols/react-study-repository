// useEffect Hook : 컴포넌트 라이프 사이클(mount -> update -> unmount) 상에서 필요한 순간에 작업하기 위한 hook
...
const LifecycleDemo = () => {
    ...
    useEffect(()=>{
        ...
        // useEffect clean up : 언마운트시에 실행할 작업을 화살표 함수로 정의해 리턴한다.
        return () => {
    ...
    useEffect(()=>{
        // state or props가 변경시 렌더링 될 때 실행 
